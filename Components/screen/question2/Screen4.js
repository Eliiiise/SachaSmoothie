    ...
    return (
        <KeyboardAvoidingView style={styles.container} behavior="position" enabled>
            ...
            <Text style={[styles.title, { marginTop:30}]}>
                As-tu besoin d’un peu de folie dans ta vie ?
            </Text>
            <Image  style={{width: 60, height: 90, alignSelf:'flex-end', marginTop:-80}} source={require("../../../assets/sacha.png")} />
            <Reponse text={"oui !"} marginTop={160} marginBottom={10}  pressed={pressed} nextScreen={"Screen8"}/>
            <Reponse text={"pas dutout"} marginTop={10} marginBottom={100}  pressed={pressed} nextScreen={"Screen9"}/>
