    ...
    return (
        <KeyboardAvoidingView style={styles.container} behavior="position" enabled>
            ...
            <Text style={[styles.title, { marginTop:30}]}>
                Pour que ça aille mieux il te faudrait ?
            </Text>
            <Image  style={{width: 60, height: 90, alignSelf:'flex-end', marginTop:-80}} source={require("../../../assets/sacha.png")} />
            <Reponse text={"de la douceur"} marginTop={160} marginBottom={10}  pressed={pressed} nextScreen={"Screen10"}/>
            <Reponse text={"de l’énergie"} marginTop={10} marginBottom={100}  pressed={pressed} nextScreen={"Screen11"}/>
