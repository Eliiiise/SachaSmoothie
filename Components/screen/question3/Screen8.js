...
export default function Screen4({route , navigation}) {
    ...
    return (
        <KeyboardAvoidingView style={styles.container} behavior="position" enabled>
            ...
            <Reponse text={"thé au jasmin reinventé"} marginTop={160} marginBottom={10} pressed={pressed} nextScreen={"Jasmin"}/>
            <Reponse text={"sucrée salé"} marginTop={10} marginBottom={100} pressed={pressed} nextScreen={"Poivron"}/>
