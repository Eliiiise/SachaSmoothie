...
export default function Screen4({route , navigation}) {
    ...
    return (
        <KeyboardAvoidingView style={styles.container} behavior="position" enabled>
            ...
            <Reponse text={"myrtille"} marginTop={160} marginBottom={10} pressed={pressed} nextScreen={"Myrtille"}/>
            <Reponse text={"beurre de cacahuète"} marginTop={10} marginBottom={100} pressed={pressed} nextScreen={"Banane"}/>
