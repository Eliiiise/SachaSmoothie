...
export default function Screen4({route , navigation}) {
    ...
    return (
        <KeyboardAvoidingView style={styles.container} behavior="position" enabled>
            ...
            <Reponse text={"kiwi"} marginTop={160} marginBottom={10} pressed={pressed} nextScreen={"Kiwi"}/>
            <Reponse text={"myrtille"} marginTop={10} marginBottom={100} pressed={pressed} nextScreen={"Myrtille"}/>
