...
export default function Screen4({route , navigation}) {
    ...
    return (
        <KeyboardAvoidingView style={styles.container} behavior="position" enabled>
            ...
            <Reponse text={"salé"} marginTop={160} marginBottom={10}  pressed={pressed} nextScreen={"Avocat"}/>
            <Reponse text={"sucrée"} marginTop={10} marginBottom={100} pressed={pressed} nextScreen={"Banane"}/>
